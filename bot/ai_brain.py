        ...
        return (
            ...
            + (
                ...
                if (
                    ...
                    "- 3-CONFIRMATION MATRIX & CROSS-ASSET SIGNALS (three_confirmation):\n"
                    "  * all_three_aligned (DXY falling, Yields falling, Gold bullish): Prime long environment; size up long exposure.\n"
                    "  * divergent_warning (gold_dollar_divergence is True): DXY rising but Gold holding bullish structure (Case C sovereign/central-bank demand). Strictly PROHIBIT opening short positions; defend longs.\n"
                    "  * oil_trend: 'cooling_inflation' indicates crude oil drop easing yield pressure, an extra bullish tailwind.\n"
                    "- MANDATORY DOLLAR INDEX & ECONOMIC DATA MIXED REVERSAL RULE:\n"
                    "  If analysis shows economic data for the US Dollar Index (DXY / UUP) is mixed or neutral (precious_metals_intel.dollar_trend is 'neutral', dollar_mixed is True, or macro releases are conflicting) OR gold_dollar_divergence is True:\n"
                    "  * If currently holding an open SELL/SHORT position (position_qty < 0): you MUST immediately CLOSE/COVER\n"
                    "    the short position and reverse/enter a LONG position (action='buy'). A mixed dollar backdrop or bullish decoupling undermines\n"
