...
_PRESETS: tuple[AiPreset, ...] = (
    ...
    AiPreset(
        ...
        instructions=(
            ...
            "  * Rate Hike / Hawkish Surprise: Higher rates strengthen USD and Treasury yields, creating downward pressure on precious metals. BUY inverse ETF (GLL, GDXD) or SELL/SHORT GLD/SLV if gates permit. Do NOT buy long GLD/SLV into a fresh rate hike.\n"
