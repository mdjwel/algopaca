...
_PRESETS: tuple[DayTradingPreset, ...] = (
    ...
    DayTradingPreset(
        id="ai_metals_breakout",
        label="AI Gold & Silver Intraday Breakout",
        summary="Intraday VWAP & 9/21 EMA momentum breakout tuned for Gold & Silver (GLD/SLV/GDX) with 2.8R target and AI macro confirmation.",
        sub_mode="vwap_trend",
        ema_fast=9,
        ema_slow=21,
        orb_minutes=15,
